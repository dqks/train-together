...
class UserController {
        ...
        try {
            ...
            const newUser = await db
                .query(
                    ...
                    + 'values ($1, $2, $3, (SELECT id FROM roles WHERE roles.name = $4)) RETURNING id, nickname',
    ...
    async login(req, res) {
        try {
            ...
            const users = await db.query('SELECT id, email, nickname, password FROM users');
